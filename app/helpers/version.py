...
def get_app_version():
    """
    Obtiene la versión de la aplicación (actualizada automáticamente)
    Formato: MAJOR.MINOR.PATCH (ej: 2.1.0, 2.1.1, 2.1.2)
    Se actualiza automáticamente basándose en la fecha de última modificación
    
    Returns:
        str: Versión de la aplicación
    """
    # Intentar obtener versión desde git primero
    ...
    # Si no hay git, usar versión basada en fecha de modificación
