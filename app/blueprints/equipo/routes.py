...
def listar():
    ...
    try:
        ...
        return render_template('admin/equipo/listar.html', employees=employees)
...
def api_employees():
    ...
    if request.method == 'GET':
        ...
        try:
            # Solo empleados locales Y activos
...
def api_cargo_salaries():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            db.session.commit()
            current_app.logger.info("Sueldos por cargo actualizados")
...
def api_cargos():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            db.session.commit()
            current_app.logger.info(f"✅ Cargo actualizado: {cargo.nombre}")
