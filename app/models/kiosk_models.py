...
class Pago(db.Model):
    ...
    metodo = db.Column(db.String(20), default='SUMUP', nullable=False)
    kiosko_id = db.Column(db.String(50), nullable=False)
    
    # SumUp fields
    sumup_transaction_id = db.Column(db.String(100), nullable=True)
    sumup_checkout_id = db.Column(db.String(100), nullable=True)
